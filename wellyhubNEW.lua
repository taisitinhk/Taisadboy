for i, v in pairs(game.CoreGui:GetChildren()) do
	if v:IsA("ScreenGui") and v.Name == "ToogleUiTaidz" then
		v:Destroy()
	end
end
...
local Window = Fluent:CreateWindow({
    Title = "Welly▪︎Hub [Free] | bloxfruits",
    SubTitle = "By Taidzz ",
    TabWidth = 160,
...
do
    ...
    _G.FastAttackDelay = 0.000000001
            ...
            if _G.killplayersautrial then
                ...
                for i, v in pairs((game:GetService("Workspace")).Characters:GetChildren()) do
                    if v.Name ~= game.Players.LocalPlayer.Name and
                        (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <=
                        200 and game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible == true and GetDistance(TempleCFrame) <= 300 then
                        if v.Humanoid.Health >= 0 then
                            repeat
                                wait()
                                ...
                                Click()
                                AttackHit()
                            until not _G.killplayersautrial or not v.Parent or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible == false
                        end
                    end
                end
            end
